...
public class HillCipher {
    ...
    int[] lm; //Line Matrix
    int[][] km; //Key Matrix
    int[] rm; //Result Matrix
    static int choice;
    int[][] invK; //Inverse Key
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.println("Input text (lowercase): ");
        String line = in.readLine();
        
        System.out.println("Input key (alfabet lowercase): ");
        String key = in.readLine();
        
        double sq = Math.sqrt(key.length());
        if (sq != (long) sq) {
            System.out.println("Tidak membentuk matrix kotak");
        } else {
            int size = (int) sq;
